describe('core fields directives: ', function() {
    ...
    beforeEach(module('${baseModule}.core.directives.fields'));
    ...
    describe('date-field', function() {
        ...
        beforeEach(function () {
            \$httpBackend.expectGET('/${modulePath}/core/directives/fields/date-field.html').respond("<input datepicker-popup='' ng-model='ngModel' />");
