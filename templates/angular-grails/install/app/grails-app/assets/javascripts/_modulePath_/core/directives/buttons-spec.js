describe('core button directives: ', function() {
	...
	beforeEach(module('${baseModule}.core.directives.buttons'));
    ...
    describe('create button: ', function() {
        ...
        beforeEach(function () {
            \$httpBackend.expectGET('/${modulePath}/core/directives/buttons/create-button.html').respond("<button>Create</button>");
    ...
    describe('edit button: ', function() {
        ...
        beforeEach(function () {
            \$httpBackend.expectGET('/${modulePath}/core/directives/buttons/edit-button.html').respond("<button>Edit</button>");
