...
```bash
lazybones create http://dl.bintray.com/craigburke/lazybones/angular-grails-template-0.5.1.zip my-project
```
...
```bash
lazybones create angular-grails 0.5.1 my-project
```
