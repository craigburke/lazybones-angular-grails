...
```bash
lazybones create http://dl.bintray.com/craigburke/lazybones/angular-grails-template-1.0.0-SNAPSHOT.zip my-project
```
...
```bash
lazybones create angular-grails 1.0.0-SNAPSHOT my-project
```
